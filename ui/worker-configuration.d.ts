/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3c5ef6059634b34ab32b7cf3e503e9df)
// Runtime types generated with workerd@1.20250902.0 2025-08-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "production" | "development";
		API_BASE_URL: "https://memory-server.dev-286.workers.dev" | "http://localhost:8787";
		API_SERVICE: Fetcher /* memory-server */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "API_BASE_URL">> {}
}
